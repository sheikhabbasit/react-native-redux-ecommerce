export const Products = [
  {
    id: 1,
    name: 'Yummy Burger 🍔 (100, 200 , 300) grams',
    price: 100,
  ...
  {
    id: 2,
    name: 'The Berry Pastry 🍰 (100, 200 , 300) grams',
    price: 200,
  ...
  {
    id: 3,
    name: 'Black Sandwich 🥪 (100, 200 , 300) grams',
    price: 300,
  ...
  {
    id: 4,
    name: 'Popular Pizza 🍕 (100, 200 , 300) grams',
    price: 400,
    imageSource: require('../Resources/Images/product4.jpg'),
    discount: '40%',
    description:
      'Ut efficitur neque eget neque lobortis, et pellentesque ex pulvinar. Sed feugiat diam eu viverra bibendum. Quisque lobortis, leo a fermentum eleifend, quam lectus molestie ante, et egestas lectus ipsum quis ex. Integer varius velit ac magna finibus eleifend. Etiam vitae odio quam. Morbi interdum mattis placerat. Integer et lectus ut massa hendrerit facilisis. Nam eget ex vitae elit vehicula eleifend sit amet at urna. Nullam felis erat, dictum eu accumsan vel, facilisis sed lorem. Curabitur et nibh ultricies, sodales sapien vel, euismod lectus. Sed nec facilisis justo, id dictum dui. Vestibulum consectetur consequat turpis, molestie egestas turpis. Integer mattis semper orci, pellentesque consectetur tortor dictum a. Curabitur mauris neque, posuere id tortor vitae, vulputate efficitur velit.',
  },
  {
    id: 5,
    name: 'Our Special 🍪 (100, 200 , 300) grams',
    price: 500,
